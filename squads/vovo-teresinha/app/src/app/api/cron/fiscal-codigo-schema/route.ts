...
const SCHEMA_ESPERADO: Record<string, string[]> = {
  ...
  lista_compras: ["id", "usuario_id", "nome", "quantidade", "unidade", "comprado", "criado_em"],
  geladeira_ingredientes: ["id", "usuario_id", "nome", "quantidade", "unidade", "criado_em"],
  push_subscriptions: ["id", "usuario_id", "endpoint", "chave_p256dh", "chave_auth", "ativo", "criado_em"],
  whatsapp_fila: ["id", "numero", "mensagem", "status", "criado_em"],
  falhas_agentes: ["id", "agente", "erro", "dados", "tentativas", "resolvido", "criado_em"],
  app_configuracoes: ["id", "chave", "valor"],
