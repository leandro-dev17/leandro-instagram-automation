...
const SCHEMA_ESPERADO: Record<string, string[]> = {
  ...
  noticias: ["id", "titulo", "fonte", "url", "resumo_braga", "resumo_cavalcanti", "categoria",
    "urgente", "global", "postada_basico", "postada_patriota", "postada_vip", "postada_elite",
    "postada_basico_at", "postada_patriota_at", "postada_vip_at", "postada_elite_at", "created_at"],
