...
const SQUAD_REVISAO = [
  { agente: "fiscal-codigo-seguranca",   rota: "/api/cron/fiscal-codigo-seguranca",   maxHoras: 6 },
  { agente: "fiscal-codigo-schema",      rota: "/api/cron/fiscal-codigo-schema",      maxHoras: 6 },
  { agente: "fiscal-codigo-logica",      rota: "/api/cron/fiscal-codigo-logica",      maxHoras: 6 },
  { agente: "fiscal-codigo-performance", rota: "/api/cron/fiscal-codigo-performance", maxHoras: 6 },
  { agente: "gerente-codigo",            rota: "/api/cron/gerente-codigo",            maxHoras: 2 },
];
